  ...
  publicAPI.getRepresentationStates = function () {
    let input =
      arguments.length > 0 && arguments[0] !== undefined
        ? arguments[0]
        : model.inputData[0];
    return superGetRepresentationStates(input).filter(
...
function extend(publicAPI, model) {
  ...
  vtkCurveContextRepresentation(publicAPI, model);
}
...
var vtkCurveContextRepresentation$1 = {
  newInstance,
  extend,
};

export { vtkCurveContextRepresentation$1 as default, extend, newInstance };
